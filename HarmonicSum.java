...
public class HarmonicSum {
    public static void main (String[] args) {
        ...
        if (sumL2R > sumR2L) {
            ...
            System.out.println("The sum from left-to-right is larger. Absolute Difference: " + absDiff); 
        } else {
            absDiff = sumR2L - sumL2R;
            System.out.println("The sum from right-to-left is larger. Absolute Difference: " + absDiff);  
        }
    }
}